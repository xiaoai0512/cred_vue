...
<template>
    ...
    <!-- 表单验证demo: -->
        ...
        <div class="cl_tr text_center">
       	...
       	<!--修改-->
        <el-dialog title="MC拒付维护页面" :visible.sync="dialogFormVisibleUp" width="65%">
            <el-form ref="dataFormUp" :rules="rulesUp" :model="tempUp" >
               	<el-form-item class="cl_td" label="MIT" prop="mti">
                ...
                <el-form-item class="cl_td" label="处理码" prop="customerNo">
                ...
                <el-form-item class="cl_td" label="日期时间" prop="dateAndTime">
                 ...
                 <el-form-item class="cl_td" label="截止日期" prop="dateExpiration">
                    <el-input v-model="tempUp.dateExpiration" class="wd200" type="text" readonly/>
                </el-form-item>
                ...
                <el-form-item class="cl_td" label="功能码" prop="functionCode">
                    <el-select v-model="tempUp.functionCode" class="wd200">
                        <el-option
                            v-for="(item, index ) in functionCodeOptions"
                            :key="index"
                           	:label="item.detailDesc"
                            :value="item.codes"/>
                    </el-select>
               ...
               <el-form-item class="cl_td" label="收单机构参考号" prop="acquireReferenceNumbr">
                ...
                <el-form-item class="cl_td" label="服务代码" prop="serviceCode">
                    <el-input v-model="tempUp.serviceCode" class="wd200" type="text" readonly/>
                </el-form-item>
                ...
                <el-form-item class="cl_td" label="附加数据" prop="additionalData">
                    <el-input v-model="tempUp.additionalData" class="wd200" type="text" readonly/>
                </el-form-item>
                ...
                <el-form-item class="cl_td" label="额外金额" prop="amountsAdditional" maxlength="120">
               		<el-input v-model="tempUp.amountsAdditional" class="wd200" type="text"/>
                </el-form-item>
                ...
                <el-form-item class="cl_td" label="数据记录" prop="dataRecord">
               		<el-input v-model="tempUp.dataRecord" class="wd200" type="text" maxlength="999"/>
                </el-form-item>
                ...
                <el-form-item class="cl_td" label="拒付状态" prop="protestStatus">
                    <el-select v-model="tempUp.protestStatus" class="wd200">
                        <el-option
                            v-for="(item, index ) in protestStatusOptions"
                            :key="index"
                           	:label="item.detailDesc"
                            :value="item.codes"/>
                    </el-select>
        ...
        <!--查询-->
        <el-dialog title="查询MC拒付页面" :visible.sync="dialogFormVisibleDetail" width="65%">
            <el-form ref="dataFormDetail" :rules="rulesDetail" :model="tempDetail" >
                ...
                <el-form-item class="cl_td" label="日期时间" prop="dateAndTime">
                 ...
                 <el-form-item class="cl_td" label="截止日期" prop="dateExpiration">
                    <el-input v-model="tempDetail.dateExpiration" class="wd200" type="text" readonly/>
                </el-form-item>
                <el-form-item class="cl_td" label="POS进入模式" prop="posEntryMode">
                    <el-input v-model="tempDetail.posEntryMode" class="wd200" type="text" readonly/>
                </el-form-item>
                <el-form-item class="cl_td" label="功能码" prop="functionCode">
                    <el-select v-model="tempDetail.functionCode" class="wd200">
                        <el-option
                            v-for="(item, index ) in functionCodeOptions"
                            :key="index"
                           	:label="item.detailDesc"
                ...
                <el-form-item class="cl_td" label="消息原因代码" prop="messageReasonCode">
                	<el-select v-model="tempDetail.messageReasonCode" class="wd200">
                        <el-option
                            v-for="(item, index ) in messageReasonCodeOptions"
                            :key="index"
                           	:label="item.detailDesc"
                ...
                <el-form-item class="cl_td" label="原始金额" prop="originalAmountReconciliation">
                    <el-input v-model="tempDetail.originalAmountReconciliation" class="wd200" type="text" maxlength="12"/>
                </el-form-item>
               <el-form-item class="cl_td" label="收单机构参考号" prop="acquireReferenceNumbr">
                ...
                <el-form-item class="cl_td" label="额外金额" prop="amountsAdditional" maxlength="120">
               		<el-input v-model="tempDetail.amountsAdditional" class="wd200" type="text"/>
                </el-form-item>
                <el-form-item class="cl_td" label="交易生命周期id" prop="transLifeCycleId">
                ...
                <el-form-item class="cl_td" label="数据记录" prop="dataRecord">
               		<el-input v-model="tempDetailUp.dataRecord" class="wd200" type="text" maxlength="999"/>
                </el-form-item>
                <el-form-item class="cl_td" label="交易发起机构" prop="transOriginInstit">
               		<el-input v-model="tempDetail.transOriginInstit" class="wd200" type="text" readonly/>
                </el-form-item>
                <el-form-item class="cl_td" label="发卡机构参考数据" prop="cardIssuerReferenceData">
               		<el-input v-model="tempDetail.cardIssuerReferenceData" class="wd200" type="text" maxlength="10"/>
                </el-form-item>
                <el-form-item class="cl_td" label="原交易全局流水号" prop="oldGlobalSerialNumbr">
               		<el-input v-model="tempDetail.oldGlobalSerialNumbr" class="wd200" type="text" readonly/>
                </el-form-item>
                <el-form-item class="cl_td" label="拒付状态" prop="protestStatus">
                    <el-select v-model="tempDetail.protestStatus" class="wd200">
                        <el-option
                            v-for="(item, index ) in protestStatusOptions"
                            :key="index"
                           	:label="item.detailDesc"
    ...
    export default {
      ...
      components: {
        ...
        data() {
            return {
                ...
                messageReasonCodeOptions: [],//消息原因代码
               	protestStatusOptions: [],//拒付状态
               	functionCodeOptions: [],//功能码
            }
        },
        created() {
        ...
        mounted() {
           ...
           //消息原因代码
           	...
           	this.getSelectDict( "dic_protestStatus").then(res => {
                this.protestStatusOptions = res
            })
           	//功能码
           	this.getSelectDict( "dic_functionCode").then(res => {
        ...
        handleUpdate(row){
      	...
      	//修改保存
       	subUpData(){
       		if(this.tempUp.protestStatus == null || this.tempUp.protestStatus == "" ||
				this.tempUp.protestStatus == 'N'){
