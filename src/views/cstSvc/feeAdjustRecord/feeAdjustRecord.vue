...
<template>
    ...
    <!-- 表单验证demo: -->
        ...
        <el-table  v-loading = "listLoading" :data="queryList"  ref="tableListRef" 
        ...
        <el-form ref="dataForm" :rules="costAdjustmentRules" :model="costAdjustment">
            <el-form-item class="cl_td" label="全局流水号" prop="ecommOrigGlobalSerialNumbr" >
                <el-input v-model="costAdjustment.ecommOrigGlobalSerialNumbr" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="外部识别号" prop="ecommEntryId"  :rules="[ { required: true, message: '外部识别号不能为空'} ]">
                <el-input v-model="costAdjustment.ecommEntryId" class="wd200" type="text" />
            </el-form-item>
             <el-form-item class="cl_td" label="原事件编号" prop="ecommOrigEventId" >
                <el-input v-model="costAdjustment.ecommOrigEventId" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="交易币种" prop="currencyCode" :rules="[ { required: true, message: '交易币种不能为空'} ]">
                <el-select v-model="costAdjustment.currencyCode" class="wd200">
             ...
             <el-form-item class="cl_td" label="交易金额" prop="ecommTransAmount" :rules="[ { required: true, message: '交易金额不能为空'} ]">
                <el-input v-model="costAdjustment.ecommTransAmount" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="交易日期" prop="ecommTransDate" width="100" :rules="[ {required: true, message: '交易日期不能为空'} ]">
                <el-date-picker class="W200_date"
                  v-model="costAdjustment.ecommTransDate"
                  type="date"
            ...
            <!--<el-form-item class="cl_td" label="交易状态" prop="ecommTransStatus">
                <el-select v-model="costAdjustment.ecommTransStatus" class="wd200">
            ...
            <el-form-item class="cl_td" label="交易描述" prop="ecommTransDesc">
                <el-input v-model="costAdjustment.ecommTransDesc" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="原始交易日期" prop="ecommOriTransDate" width="100">
                <el-date-picker class="W200_date"
                  v-model="costAdjustment.ecommOriTransDate"
                  type="date"
                  value-format="yyyy-MM-dd"    
                  placeholder="选择日期">
                </el-date-picker>
            </el-form-item>
            <el-form-item class="cl_td" label="MCC外部识别号" prop="ecommMcc">
                <el-input v-model="costAdjustment.ecommMcc" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="交易国家代码" prop="ecommTransCountryCde">
                <el-input v-model="costAdjustment.ecommTransCountryCde" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="交易城市代码" prop="ecommTransCityCde">
                <el-input v-model="costAdjustment.ecommTransCityCde" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="交易来源" prop="originList" >
                <el-select v-model="costAdjustment.originList" class="wd200">
            ...
            <!--<el-form-item class="cl_td" label="渠道代码" prop="ecommChannelCde">
                <el-input v-model="costAdjustment.ecommChannelCde" class="wd200" type="text" />
            </el-form-item>-->
            <el-form-item class="cl_td" label="交易机构" prop="organNo">
                <el-select v-model="costAdjustment.organNo" class="wd200">
            ...
            <el-form-item class="cl_td" label="商户编号" prop="ecommMerchantCde">
                <el-input v-model="costAdjustment.ecommMerchantCde" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="收单参考号" prop="ecommAcquireReferenceNumbr">
                <el-input v-model="costAdjustment.ecommAcquireReferenceNumbr" class="wd200" type="text" />
            </el-form-item>
            <div class="cl_tr text_center">
                <el-button size="medium" round icon="el-icon-plus" type="primary" @click="getDataInfo(costAdjustment)" >确定</el-button>
           </div>
        </el-form>
    </div>
</template>
        ...
        this.getTableList('/beta/betaService/COS.IQ.02.0039', obj ,(res) => {
            if (res.returnCode == '000000') {
                if (res.returnData && res.returnData.rows && res.returnData.rows.length > 0 ) {
                    this.queryList = res.returnData.rows
   ...
   //交易日期&&原始交易日期
        ...
        this.post('/beta/betaService/COS.IQ.02.0038', obj ,(res) => {
            if (res.returnCode == '000000') {
                if (res.returnData && res.returnData.rows && res.returnData.rows.length > 0 ) {
                    ...
                    this.$set(this.costAdjustment, "ecommTransDate", new Date());
                    this.$set(this.costAdjustment, "ecommOriTransDate", new Date());
                    this.costAdjustment.ecommTransDate = res.returnData.rows[0].nextProcessDate;
                    this.costAdjustment.ecommOriTransDate = res.returnData.rows[0].nextProcessDate;
                }
            }
        })
    },
    ...
    getDataInfo(item) {
        ...
        let obj={
            ...
            ecommTransPostingAmount: item.currencyCode,
            ecommEventId: this.dataSetForm.eventNo
        }
        this.costAdjustment = Object.assign(this.costAdjustment, obj)
        this.$refs['dataForm'].validate((valid) => {
            if (valid) {
                this.post('/card/cardService/ISS.RT.60.1001',  this.costAdjustment, (res) => {
                    if (res.returnCode == '000000') {
                        this.$notify({
                        title: 'Success',
                        message: '交易补录成功',
