    ...
    <div class="allContent">
        ...
        <div v-if="showTable">
            ...
            >
                ...
                <el-table-column prop="mediaUnitCode" label="媒介单元代码" align="center" width="200"/>
            ...
            <div class="cl_tr text_center">
                <el-button size="medium" icon="el-icon-plus" type="primary" @click="suerHandle()">确定注销</el-button>
            </div>
        </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      suerHandle() {
        ...
        this.post('/nonfi/nonfinanceService/BSS.OP.01.0018', params , (res) => {
            if (res.returnCode == '000000') {
                this.$notify({
                    title: 'Success',
                    message: '注销成功',
