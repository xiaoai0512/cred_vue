...
<template>
    ...
    <!-- 表单验证demo: -->
	        ...
	        <el-table v-loading = "listLoading" :data="tableList" class="mbtm20" fit highlight-current-row  style="width: 100%;" border>
	            ...
	            <el-table-column prop="nextBillDate" label="下一账单日期" align="center"/>
	           	<el-table-column prop="" label="操作" align="center" width = "350">
	                ...
	                <el-button size="mini" icon="el-icon-edit"   type="primary" @click="handleUpdate(row)">修改账单日</el-button><!--v-show="updBtnFlag"-->
    	...
    	<!--修改-->
    	<el-dialog title="修改账单日" :visible.sync="dialogFormVisibleUp" width="65%">
    		<el-form ref="upRef" :model="tempUp" :rules="upRules">
                <el-form-item class="cl_td" label="客户代码" prop="customerNo" >
               	...
               	<el-form-item class="cl_td" label="业务项目代码" prop="businessProgramNo" >
                    <el-input v-model="tempUp.businessProgramNo" class="wd200" type="text" readonly />
               	</el-form-item>
               	<el-form-item class="cl_td" label="账单日" prop="billDayMonth">
                    <el-select v-model="tempUp.billDayMonth" class="wd200" >
                        <el-option 
                            v-for="(item, index) in billDayMonthOptions" 
                            :key="index" 
                            :label="item.detailDesc" 
                            :value="item.codes"/>
                    </el-select>
                </el-form-item>
               	<el-form-item class="cl_td" label="下一张单日期" prop="nextBillDate" >
                    <el-input v-model="tempUp.nextBillDate" class="wd200" type="text" readonly />
               	</el-form-item>
    ...
    export default {
      ...
      handleSearch() {
        ...
        getList() {
            ...
            this.showDiv = true
           	this.getTableList('/nonfi/nonfinanceService/BSS.IQ.01.0020', this.queryForm,(res) => {
        ...
        handleUpdate(row) {
       	...
       	subUpData(row){
        	this.post('/nonfi/nonfinanceService/BSS.UP.01.0035', this.tempUp ,(res) => {
	            if (res.returnCode == '000000') {
