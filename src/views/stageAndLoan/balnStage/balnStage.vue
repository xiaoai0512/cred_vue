    ...
    <!-- 表单验证demo: -->
        ...
        <el-form ref="dataFormTrans" :rules="formRules" :model="transactionInfo">
            ...
            <el-form-item class="cl_td" label="分期期数" prop="ecommInstallmentPeriod" :rules="[ { required: true, message: '分期期数不能为空'} ]">
             ...
             <el-form-item class="cl_td" label="分期方式" prop="freeFlag" :rules="[ { required: true, message: '分期期数不能为空'} ]">
            ...
            <el-form-item v-if="transactionInfo.freeFlag == 'FRDM'" class="cl_td" label="参考期数" prop="ecommCalInstallmentPeriod" :rules="[ { required: transactionInfo.freeFlag == 'FRDM', message: '参考期数不能为空'} ]">
                <el-select v-model="transactionInfo.ecommCalInstallmentPeriod" class="wd200">
                    <el-option v-for="(item, index) in stageTermList" 
                    :key="index" 
                    :label="item.detailDesc" 
                    :value="item.codes" />
                </el-select>
        ...
        <el-dialog title="分期试算" :visible.sync="dialogFormVisibleTrans" width="65%">
         <el-form   :data="tableTrialDetail" class="mbtm20" fit highlight-current-row style="width: 100%;" border>
            <el-form-item class="cl_td" label="外部识别号" prop="externalIdentificationNo">
                <el-input v-model="tableTrialDetail.externalIdentificationNo" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="业务类型" prop="ecommBusineseType" >
                <el-input v-model="tableTrialDetail.ecommBusineseType" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="金额" prop="loanAmt" >
                <el-input v-model="tableTrialDetail.loanAmt" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="币种" prop="currencyCode" >
                <el-input v-model="tableTrialDetail.currencyCode" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="利率 %" prop="loanRate" >
                <el-input v-model="tableTrialDetail.loanRate" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="费率" prop="feeRate" >
                <el-input v-model="tableTrialDetail.feeRate" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="总费用" prop="allFeeAmt" >
                <el-input v-model="tableTrialDetail.allFeeAmt" class="wd200" type="text" />
            </el-form-item>
            <el-form-item class="cl_td" label="总期数" prop="term" >
                <el-input v-model="tableTrialDetail.term" class="wd200" type="text" />
            </el-form-item>
        </el-form >
