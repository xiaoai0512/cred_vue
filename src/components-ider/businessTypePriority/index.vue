    ...
    <div class="">
        <el-form :inline="true" ref="queryFormRef" :model="queryFormObj" :rules="queryFormRules" class="demo-form-inline">
            <el-form-item label="业务类型代码" prop="businessTypeCode">
                <el-input v-model="queryFormObj.businessTypeCode" type="text"/>
            </el-form-item>
            <el-form-item label="业务类型描述" prop="businessDesc">
                <el-input v-model="queryFormObj.businessDesc" type="text"/>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  methods: {
    getList(){
        this.getTableList('/beta/betaService/COS.IQ.02.0020', this.queryFormObj ,(res) => {
    ...
    reset() {
        this.queryFormObj.businessTypeCode = ''
        this.queryFormObj.businessDesc = ''
