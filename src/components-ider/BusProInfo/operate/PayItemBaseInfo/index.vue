    ...
    <div class="" >
        <el-form ref="formRef" :model="formObj" :rules="formRules">
            ...
            <el-form-item class="cl_td" label="实例代码1" prop="instanCode1">
                <el-input v-model="formObj.instanCode1" class="wd200" type="text" :readonly="isReadonly" @focus="choseInstanCodeBtn(1)"/>
            ...
            <el-form-item class="cl_td" label="实例代码2" prop="instanCode2">
                <el-input v-model="formObj.instanCode2" class="wd200" type="text" :readonly="isReadonly" @focus="choseInstanCodeBtn(2)"/>
                 <div class="search_button" v-if="showChoseBtn">
            ...
            <el-form-item class="cl_td" label="实例代码3" prop="instanCode3">
                <el-input v-model="formObj.instanCode3" class="wd200" type="text" :readonly="isReadonly" @focus="choseInstanCodeBtn(3)"/>
                 <div class="search_button" v-if="showChoseBtn">
            ...
            <el-form-item class="cl_td" label="实例代码4" prop="instanCode4">
                <el-input v-model="formObj.instanCode4" class="wd200" type="text" :readonly="isReadonly" @focus="choseInstanCodeBtn(4)"/>
                 <div class="search_button" v-if="showChoseBtn">
            ...
            <el-form-item class="cl_td" label="实例代码5" prop="instanCode5">
                <el-input v-model="formObj.instanCode5" class="wd200" type="text" :readonly="isReadonly" @focus="choseInstanCodeBtn(5)"/>
                 <div class="search_button" v-if="showChoseBtn">
